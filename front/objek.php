...
<?php
	...
	// panggil data artikel berdasarkan kategori objek yang di ambil dari link
...
<div class="jumbotron">
	<h1>Objek wisata </h1>
	<h4>Mengenal objek wisata kota palembang lebih dekat</h4>
...
<div class="col-sm-6 col-md-4">
		...
		<div class="thumbnail">
				...
				list($nama_gambar)=mysqli_fetch_row($gambar);
					...
					if($gambar) : ?>
						<img class="img-thumbnail"src="../back/satpam/img/<?php echo $nama_gambar ; ?>"  width="242" height="200" alt="...">
